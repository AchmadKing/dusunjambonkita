...
(1, 'Dokumen & Foto Asal-Usul Dusun (Kegiatan 1)', 'Sejarah & Arsip', 'Kegiatan 1', 'assets/kegiatan1.jpg', 'slideshow'),
(2, 'Dokumen & Foto Asal-Usul Dusun (Kegiatan 2)', 'Sejarah & Arsip', 'Kegiatan 2', 'assets/kegiatan2.jpg', 'slideshow'),
(3, 'Dokumen & Foto Asal-Usul Dusun (Kegiatan 3)', 'Sejarah & Arsip', 'Kegiatan 3', 'assets/kegiatan3.jpg', 'slideshow'),
(4, 'Dokumen & Foto Asal-Usul Dusun (Kegiatan 4)', 'Sejarah & Arsip', 'Kegiatan 4', 'assets/kegiatan4.jpg', 'slideshow'),
(5, 'Dokumentasi Kegiatan 1', 'Dokumentasi Kegiatan Warga Dusun Jambon', 'Kegiatan 1', 'assets/kegiatan1.jpg', 'gallery'),
(6, 'Dokumentasi Kegiatan 2', 'Dokumentasi Kegiatan Warga Dusun Jambon', 'Kegiatan 2', 'assets/kegiatan2.jpg', 'gallery'),
(7, 'Dokumentasi Kegiatan 3', 'Dokumentasi Kegiatan Warga Dusun Jambon', 'Kegiatan 3', 'assets/kegiatan3.jpg', 'gallery'),
(8, 'Dokumentasi Kegiatan 4', 'Dokumentasi Kegiatan Warga Dusun Jambon', 'Kegiatan 4', 'assets/kegiatan4.jpg', 'gallery')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO administrasi_peta (id, map_title, map_desc, map_image_url) VALUES (
    ...
    'assets/PetaAdministrasiJambon.png'
) ON CONFLICT (id) DO NOTHING;
...
(1, 'Masjid Al-Falah', 'ibadah', 'Tempat Ibadah', 'red', 'Pusat peribadatan utama dan kegiatan keagamaan warga Dusun Jambon.', '-7.662602, 110.26933', 'https://www.google.com/maps?q=-7.662602,110.26933', 'assets/Masjid_Al-Falah.jpg'),
(2, 'Rumah RT 01', 'rt', 'Pengurus RT 01', 'blue', 'Pusat koordinasi pelayanan warga untuk wilayah Rukun Tetangga 01.', '-7.661971, 110.268369', 'https://www.google.com/maps?q=-7.661971,110.268369', 'assets/Rumah_RT1.jpg'),
(3, 'Rumah RT 02', 'rt', 'Pengurus RT 02', 'blue', 'Pusat koordinasi pelayanan warga untuk wilayah Rukun Tetangga 02.', '-7.661751, 110.269771', 'https://www.google.com/maps?q=-7.661751,110.269771', 'assets/Rumah_RT2.jpg'),
(4, 'Rumah RT 03', 'rt', 'Pengurus RT 03', 'blue', 'Pusat koordinasi pelayanan warga untuk wilayah Rukun Tetangga 03.', '-7.662700, 110.269351', 'https://www.google.com/maps?q=-7.662700,110.269351', 'assets/Rumah_RT3.jpg'),
(5, 'Rumah RT 04', 'rt', 'Pengurus RT 04', 'blue', 'Pusat koordinasi pelayanan warga untuk wilayah Rukun Tetangga 04.', '-7.663517, 110.269899', 'https://www.google.com/maps?q=-7.663517,110.269899', 'assets/Rumah_RT4.jpg'),
(6, 'Rumah RT 05', 'rt', 'Pengurus RT 05', 'blue', 'Pusat koordinasi pelayanan warga untuk wilayah Rukun Tetangga 05.', '-7.663298, 110.269126', 'https://www.google.com/maps?q=-7.663298,110.269126', 'assets/Rumah_RT5.jpg')
ON CONFLICT (id) DO NOTHING;
